...
Um conjunto de skills para trabalhar com Claude (ou qualquer outro LLM asistent) de forma mais intencional — do contexto pessoal até a criação de novas capacidades.
